...
class HallsController extends Controller
{
    public function index() {
        return view ('admin', ['halls'=>Hall::all(), 'films'=>Film::all(), 'sessions'=>Session::all()]); 
    }

    public function indexClient() {
        return view ('index', ['halls'=>Hall::all(), 'films'=>Film::all(), 'sessions'=>Session::where('active_hall', 'on')->get()]); 
    }
    ...
    public function addHall(HallRequest $request) {
       ...
       return redirect()->route('admin')->with('success', 'Зал успешно добавлен');
        ...
        //     'vip_price'=>['exclude_unless: name, null', 'required', 'integer'], // Поле будет проверятся, если name  = null 
        //     'standart_price'=>['exclude_unless: name, null', 'required', 'integer'] // Поле будет проверятся, если name  = null
        // ]);
